...
(replace(uuid(), '-', ''), '查询全部省级行政区划', 'GET', '/common/area/v1.0/areas/provinces', NULL, 1, NULL, NULL, NULL, 0, 1, now()),
(replace(uuid(), '-', ''), '查询指定行政区划的下级区划', 'GET', '/common/area/v1.0/areas/{is}/subs', NULL, NULL, NULL, NULL, NULL, 0, 0, now()),
(replace(uuid(), '-', ''), '获取全部行政区划', 'GET', '/common/area/v1.0/areas', "getArea", 1, NULL, NULL, NULL, 1, 1, now()),
(replace(uuid(), '-', ''), '新增行政区划', 'POST', '/common/area/v1.0/areas', "addArea", 1, NULL, NULL, NULL, 1, 1, now()),
...
(replace(uuid(), '-', ''), '新增字典', 'POST', '/common/dict/v1.0/dicts', "addDict", 1, NULL, NULL, NULL, 1, 1, now()),
...
(replace(uuid(), '-', ''), '新增字典键值', 'POST', '/common/dict/v1.0/dicts/keys', "addDictKey", 1, NULL, NULL, NULL, 1, 1, now()),
(replace(uuid(), '-', ''), '编辑字典键值', 'PUT', '/common/dict/v1.0/dicts/keys', "editDictKey", 1, NULL, NULL, NULL, 1, 1, now()),
(replace(uuid(), '-', ''), '删除字典键值', 'DELETE', '/common/dict/v1.0/dicts/keys', "deleteDictKey", 1, NULL, NULL, NULL, 1, 1, now()),

(replace(uuid(), '-', ''), '获取日志列表', 'GET', '/common/log/v1.0/logs', 'getLog', 1, NULL, NULL, NULL, 1, 1, now()),
(replace(uuid(), '-', ''), '获取日志详情', 'GET', '/common/log/v1.0/logs/{id}', 'getLog', 1, NULL, NULL, NULL, 1, 1, now());
