...
(134650654863839253, '获取用户可选租户', 'GET', '/base/auth/v1.0/{id}/tenants', NULL, 1, NULL, NULL, NULL, 0, 1, now()),
(134651190399434773, '生成加密Code', 'POST', '/base/auth/v1.0/codes', NULL, NULL, 86400, 360, '获取Code接口每24小时调用次数为360次,请合理使用', 0, 1, now()),
(134653865520749589, '扫码授权', 'PUT', '/base/auth/v1.0/codes/{code}', NULL, NULL, 86400, 360, '扫码授权接口每24小时调用次数为360次,请合理使用', 1, 1, now()),
(134654455520749589, '生成Token', 'POST', '/base/auth/v1.0/tokens', NULL, 1, NULL, NULL, '获取Token接口每24小时调用次数为360次,请合理使用', 0, 1, now()),
(134654810484449301, '刷新Token', 'PUT', '/base/auth/v1.0/tokens', NULL, NULL, 3600, 10, '刷新Token接口每小时调用次数为10次,请合理使用', 0, 1, now()),
(134655174327074837, '用户账号离线', 'DELETE', '/base/auth/v1.0/tokens', NULL, NULL, NULL, NULL, NULL, 1, 0, now()),
(134656969383878677, '获取用户导航栏', 'GET', '/base/auth/v1.0/navigators', NULL, 1, NULL, NULL, NULL, 1, 1, now()),
(134657950754545685, '获取模块功能', 'GET', '/base/auth/v1.0/navigators/{id}/functions', NULL, 1, NULL, NULL, NULL, 1, 1, now()),
