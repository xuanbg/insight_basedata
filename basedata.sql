...
(134650654863839020, '生成加密Code', 'POST', '/base/auth/v1.0/codes', NULL, NULL, 86400, 360, '获取Code接口每24小时调用次数为360次,请合理使用', 0, 1, now()),
(134650654863839030, '扫码授权', 'PUT', '/base/auth/v1.0/codes/{code}', NULL, NULL, 86400, 360, '扫码授权接口每24小时调用次数为360次,请合理使用', 1, 1, now()),
(134650654863839040, '生成Token', 'POST', '/base/auth/v1.0/tokens', NULL, 1, NULL, NULL, '获取Token接口每24小时调用次数为360次,请合理使用', 0, 1, now()),
(134650654863839050, '刷新Token', 'PUT', '/base/auth/v1.0/tokens', NULL, NULL, 3600, 10, '刷新Token接口每小时调用次数为10次,请合理使用', 0, 1, now()),
...
(134650654863841000, '发送短信验证码', 'POST', '/common/message/v1.0/codes', NULL, 10, 86400, 30, '今日验证码次数已达上限,请合理使用短信验证码', 0, 1, now()),
(134650654863841010, '验证短信验证码', 'GET', '/common/message/v1.0/codes/{key}/status', NULL, NULL, NULL, NULL, NULL, 0, 0, now()),
(134650654863841020, '发送送标准消息', 'POST', '/common/message/v1.0/messages', 'sendMessage', 10, NULL, NULL, NULL, 1, 1, now()),
(134650654863841030, '发送自定义消息', 'POST', '/common/message/v1.0/customs', 'sendCustomMessage', 10, NULL, NULL, NULL, 1, 1, now()),
(134650654863841040, '获取用户消息列表', 'GET', '/common/message/v1.0/messages', NULL, 1, NULL, NULL, NULL, 1, 1, now()),
(134650654863841050, '获取用户消息详情', 'GET', '/common/message/v1.0/messages/{id}', NULL, 1, NULL, NULL, NULL, 1, 1, now()),
(134650654863841060, '删除用户消息', 'DELETE', '/common/message/v1.0/messages', NULL, 1, NULL, NULL, NULL, 1, 1, now()),
