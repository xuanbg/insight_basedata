...
(134992978522406933, '编辑角色', 'PUT', '/base/role/v1.0/roles', 'editRole', 1, NULL, NULL, NULL, 1, 1, now()),
(134993521420533781, '删除角色', 'DELETE', '/base/role/v1.0/roles', 'deleteRole', 1, NULL, NULL, NULL, 1, 1, now()),
...
(135051787378884629, '编辑组织机构', 'PUT', '/base/organize/v1.0/organizes', 'editOrganize', 1, NULL, NULL, NULL, 1, 1, now()),
(135053741224099861, '删除组织机构', 'DELETE', '/base/organize/v1.0/organizes', 'deleteOrganize', 1, NULL, NULL, NULL, 1, 1, now()),
...
(135072926994006037, '编辑租户', 'PUT', '/base/tenant/v1.0/tenants', 'editTenant', 1, NULL, NULL, NULL, 1, 1, now()),
(135073344310476821, '删除租户', 'DELETE', '/base/tenant/v1.0/tenants', 'deleteTenant', 1, NULL, NULL, NULL, 1, 1, now()),
(135075359241535509, '审核租户', 'PUT', '/base/tenant/v1.0/tenants/status', 'auditTenant', 1, NULL, NULL, NULL, 1, 1, now()),
(135075623210057749, '禁用租户', 'PUT', '/base/tenant/v1.0/tenants/disable', 'disableTenant', 1, NULL, NULL, NULL, 1, 1, now()),
(135076131253518357, '启用租户', 'PUT', '/base/tenant/v1.0/tenants/enable', 'enableTenant', 1, NULL, NULL, NULL, 1, 1, now()),
...
(135089392644522005, '编辑用户组', 'PUT', '/base/user/v1.0/groups', 'editGroup', 1, NULL, NULL, NULL, 1, 1, now()),
(135089899907842069, '删除用户组', 'DELETE', '/base/user/v1.0/groups', 'deleteGroup', 1, NULL, NULL, NULL, 1, 1, now()),
...
(135096497157963797, '编辑应用', 'PUT', '/base/resource/v1.0/apps', 'editApp', 1, NULL, NULL, NULL, 1, 1, now()),
(135097652764213269, '删除应用', 'DELETE', '/base/resource/v1.0/apps', 'deleteApp', 1, NULL, NULL, NULL, 1, 1, now()),
...
(135101682777325589, '编辑导航', 'PUT', '/base/resource/v1.0/navigators', 'editNav', 1, NULL, NULL, NULL, 1, 1, now()),
(135101990886703125, '删除导航', 'DELETE', '/base/resource/v1.0/navigators', 'deleteNav', 1, NULL, NULL, NULL, 1, 1, now()),
...
(135103719283884053, '编辑功能', 'PUT', '/base/resource/v1.0/functions', 'editFunc', 1, NULL, NULL, NULL, 1, 1, now()),
(135104834616426517, '删除功能', 'DELETE', '/base/resource/v1.0/functions', 'deleteFunc', 1, NULL, NULL, NULL, 1, 1, now()),
...
(135108849588764693, '编辑用户', 'PUT', '/base/user/manage/v1.0/users', 'editUser', 1, NULL, NULL, NULL, 1, 1, now()),
(135109135875178517, '删除用户', 'DELETE', '/base/user/manage/v1.0/users', 'deleteUser', 1, NULL, NULL, NULL, 1, 1, now()),
(135110869842395157, '禁用用户', 'PUT', '/base/user/manage/v1.0/users/disable', 'bannedUser', 1, NULL, NULL, NULL, 1, 1, now()),
(135111115100127253, '启用用户', 'PUT', '/base/user/manage/v1.0/users/enable', 'releaseUser', 1, NULL, NULL, NULL, 1, 1, now()),
(135111142916751381, '重置用户密码', 'PUT', '/base/user/manage/v1.0/users/password', 'resetPassword', 1, NULL, NULL, NULL, 1, 1, now()),
(135111305437642773, '获取可邀请用户列表', 'GET', '/base/user/manage/v1.0/users/others', 'inviteUser', 1, NULL, NULL, NULL, 1, 1, now()),
(135112186505723925, '邀请用户', 'POST', '/base/user/manage/v1.0/users/relation', 'inviteUser', 1, NULL, NULL, NULL, 1, 1, now()),
(135112827974189077, '清退用户', 'DELETE', '/base/user/manage/v1.0/users/relation', 'removeUser', 1, NULL, NULL, NULL, 1, 1, now()),
...
(135123534128087061, '立即执行计划任务', 'PUT', '/common/message/v1.0/schedules', 'executeSchedule', 1, NULL, NULL, NULL, 1, 1, now()),
(135124181124644885, '删除计划任务', 'DELETE', '/common/message/v1.0/schedules', 'deleteSchedule', 1, NULL, NULL, NULL, 1, 1, now()),
(135125020966912021, '禁用计划任务', 'PUT', '/common/message/v1.0/schedules/disable', 'disableSchedule', 1, NULL, NULL, NULL, 1, 1, now()),
(135125379282108437, '启用计划任务', 'PUT', '/common/message/v1.0/schedules/enable', 'enableSchedule', 1, NULL, NULL, NULL, 1, 1, now()),
...
(135133177831227413, '编辑消息场景', 'PUT', '/common/message/v1.0/scenes', 'editScene', 1, NULL, NULL, NULL, 1, 1, now()),
(135133751360356373, '删除消息场景', 'DELETE', '/common/message/v1.0/scenes', 'deleteScene', 1, NULL, NULL, NULL, 1, 1, now()),
(135135163532181525, '获取场景配置列表', 'GET', '/common/message/v1.0/scenes/{id}/configs', 'getScene', 1, NULL, NULL, NULL, 1, 1, now()),
(135137013232828437, '新增场景配置', 'POST', '/common/message/v1.0/scenes/configs', 'newSceneConfig', 1, NULL, NULL, NULL, 1, 1, now()),
(135137370327482389, '编辑场景配置', 'PUT', '/common/message/v1.0/scenes/configs', 'editSceneConfig', 1, NULL, NULL, NULL, 1, 1, now()),
(135138035577651221, '删除场景配置', 'DELETE', '/common/message/v1.0/scenes/configs', 'deleteSceneConfig', 1, NULL, NULL, NULL, 1, 1, now()),
...
(135154323863633941, '编辑接口配置', 'PUT', '/common/config/v1.0/configs', 'editConfig', 1, NULL, NULL, NULL, 1, 1, now()),
(135154447327166485, '删除接口配置', 'DELETE', '/common/config/v1.0/configs', 'deleteConfig', 1, NULL, NULL, NULL, 1, 1, now()),
...
(135159422207918101, '编辑报表模板', 'PUT', '/common/report/v1.0/templates', 'editTemplate', 1, NULL, NULL, NULL, 1, 1, now()),
(135159515514404885, '删除报表模板', 'DELETE', '/common/report/v1.0/templates', 'deleteTemplate', 1, NULL, NULL, NULL, 1, 1, now()),
(135159970030157845, '设计报表模板', 'PUT', '/common/report/v1.0/templates/content', 'designTemplate', 1, NULL, NULL, NULL, 1, 1, now()),
(135160377808781333, '禁用报表模板', 'PUT', '/common/report/v1.0/templates/disable', 'disableTemplate', 1, NULL, NULL, NULL, 1, 1, now()),
(135160400734846997, '启用报表模板', 'PUT', '/common/report/v1.0/templates/enable', 'enableTemplate', 1, NULL, NULL, NULL, 1, 1, now()),
...
(135175590381617173, '编辑行政区划', 'PUT', '/common/area/v1.0/areas', "editArea", 1, NULL, NULL, NULL, 1, 1, now()),
(135176858319716373, '删除行政区划', 'DELETE', '/common/area/v1.0/areas', "deleteArea", 1, NULL, NULL, NULL, 1, 1, now()),
...
(135178642207539221, '编辑字典', 'PUT', '/common/dict/v1.0/dicts', "editDict", 1, NULL, NULL, NULL, 1, 1, now()),
(135178938505756693, '删除字典', 'DELETE', '/common/dict/v1.0/dicts', "deleteDict", 1, NULL, NULL, NULL, 1, 1, now()),
(135179306799202325, '新增字典键值', 'POST', '/common/dict/v1.0/dicts/keys', "newValue", 1, NULL, NULL, NULL, 1, 1, now()),
(135179539595657237, '编辑字典键值', 'PUT', '/common/dict/v1.0/dicts/keys', "editValue", 1, NULL, NULL, NULL, 1, 1, now()),
(135179577952567317, '删除字典键值', 'DELETE', '/common/dict/v1.0/dicts/keys', "deleteValue", 1, NULL, NULL, NULL, 1, 1, now()),
