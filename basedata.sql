...
(134650654863839280, '获取角色日志列表', 'GET', '/base/role/v1.0/roles/{id}/logs', 'getRoleLog', 1, NULL, NULL, NULL, 1, 1, now()),
...
(134650654863839380, '获取组织机构日志列表', 'GET', '/base/organize/v1.0/organizes/{id}/logs', 'getOrganizeLog', 1, NULL, NULL, NULL, 1, 1, now()),
...
(134650654863839540, '获取租户日志列表', 'GET', '/base/tenant/v1.0/tenants/{id}/logs', 'getTenantLog', 1, NULL, NULL, NULL, 1, 1, now()),
...
(134650654863839690, '获取用户组日志列表', 'GET', '/base/user/v1.0/groups/{id}/logs', 'getGroupLog', 1, NULL, NULL, NULL, 1, 1, now()),
...
(134650654863839950, '获取应用日志列表', 'GET', '/base/resource/v1.0/apps/{id}/logs', 'getAppLog', 1, NULL, NULL, NULL, 1, 1, now()),
...
(134650654863840120, '获取用户日志列表', 'GET', '/base/user/manage/v1.0/users/{id}/logs', 'getUserLog', 1, NULL, NULL, NULL, 1, 1, now()),
...
(134650654863840460, '获取计划任务日志列表', 'GET', '/common/message/v1.0/schedules/{id}/logs', 'getScheduleLog', 1, NULL, NULL, NULL, 1, 1, now()),
...
(134650654863840890, '获取消息场景日志列表', 'GET', '/common/message/v1.0/scenes/{id}/logs', 'getSceneLog', 1, NULL, NULL, NULL, 1, 1, now()),
...
(134650654863841260, '获取接口配置日志列表', 'GET', '/common/config/v1.0/configs/{id}/logs', 'getConfigLog', 1, NULL, NULL, NULL, 1, 1, now()),
...
(134650654863841520, '获取报表模板日志列表', 'GET', '/common/report/v1.0/templates/{id}/logs', 'getTemplateLog', 1, NULL, NULL, NULL, 1, 1, now()),
...
(134650654863841660, '获取行政区划日志列表', 'GET', '/common/area/v1.0/areas/{id}/logs', 'getAreaLog', 1, NULL, NULL, NULL, 1, 1, now()),
...
(134650654863841790, '获取字典日志列表', 'GET', '/common/dict/v1.0/dicts/{id}/logs', 'getDictLog', 1, NULL, NULL, NULL, 1, 1, now()),
