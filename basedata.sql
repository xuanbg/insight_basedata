...
(replace(uuid(), '-', ''), '获取场景配置列表', 'GET', '/common/message/v1.0/scenes/{id}/configs', 'getScene', 1, NULL, NULL, NULL, 1, 1, now()),
(replace(uuid(), '-', ''), '新增场景配置', 'POST', '/common/message/v1.0/scenes/configs', 'newSceneConfig', 1, NULL, NULL, NULL, 1, 1, now()),
(replace(uuid(), '-', ''), '编辑场景配置', 'PUT', '/common/message/v1.0/scenes/configs', 'editSceneConfig', 1, NULL, NULL, NULL, 1, 1, now()),
(replace(uuid(), '-', ''), '删除场景配置', 'DELETE', '/common/message/v1.0/scenes/configs', 'deleteSceneConfig', 1, NULL, NULL, NULL, 1, 1, now()),
...
(replace(uuid(), '-', ''), '获取报表实例详情', 'GET', '/common/report/v1.0/reports/{id}', NULL, NULL, NULL, NULL, NULL, 1, 0, now()),
